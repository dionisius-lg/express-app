...
exports.index = async (req, res, next) => {
    ...
    const getData = {
        [currentPath]: await productUnitsModel.getAll({ limit: limit, ...query })
    }
...
exports.detail = async (req, res, next) => {
    ...
    const result = await productUnitsModel.getDetail({
        id: params.id
    })
...
exports.create = async (req, res, next) => {
    ...
    const result = await productUnitsModel.insert(body)
...
exports.update = async (req, res, next) => {
    ...
    const result = await productUnitsModel.update(body, {
        id: params.id
    })
...
exports.delete = async (req, res, next) => {
    ...
    const result = await productUnitsModel.update(data, {
        id: params.id
    })
